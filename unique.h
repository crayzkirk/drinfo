...
typedef float  tF32;
typedef void *PVOID;
typedef void br_putline_cbfn (char *param1, void *param2);
typedef void brfile_putline_cbfn (char *param1, void *param2);
typedef int br_mode_test_cbfn (br_uint_8 *param1, br_size_t param2);
typedef br_uint_32 brfile_attributes_cbfn br_uint_32  (void param1);
typedef void (*brfile_open_read_cbfn) (char *param1, br_size_t param2, br_mode_test_cbfn *param3, int *param4);
typedef void (*brfile_open_write_cbfn) (char *param1, int param2);
typedef void brfile_close_cbfn (void *param1);
typedef void brmem_free_cbfn (void *param1);
typedef int brfile_eof_cbfn (void *param1);
typedef int brfile_getchr_cbfn (void *param1);
typedef void brfile_putchr_cbfn (int param1, void *param2);
typedef br_size_t brfile_read_cbfn (void *param1, br_size_t param2, unsigned int param3, void *param4);
typedef br_size_t brfile_write_cbfn (void *param1, br_size_t param2, unsigned int param3, void *param4);
typedef br_size_t brfile_getline_cbfn (char *param1, br_size_t param2, void *param3);
typedef void brfile_advance_cbfn (br_size_t param1, void *param2);
...
typedef void (*brmem_allocate_cbfn) (br_size_t param1, br_uint_8 param2);
typedef br_size_t brmem_inquire_cbfn (br_uint_8 param1);
typedef br_uint_32 brmem_align_cbfn (br_uint_8 param1);
...
typedef void br_resourcefree_cbfn (void *param1, br_uint_8 param2, br_size_t param3);
...
typedef void br_diag_warning_cbfn (char *param1);
typedef void br_diag_failure_cbfn (char *param1);
...
typedef br_resource_class (*br_resclass_find_cbfn)(char *param1);
typedef br_uint_32 br_resclass_enum_cbfn (br_resource_class *param1);
typedef int br_qsort_cbfn (void *param1, void *param2);
typedef br_uint_32 br_resenum_cbfn (void *param1, void *param2);
typedef struct br_device (*br_device_begin_fn) (char *param1);
...
typedef br_boolean br_device_enum_cbfn (char *param1, br_uint_32 param2, char *param3, char *param4, char *param5, char *param6, void *param7);
typedef br_boolean br_outfcty_enum_cbfn (char *param1, br_outfcty_desc *param2, void *param3, struct param4);
...
typedef void br_model_custom_cbfn (struct br_actor *param1, struct br_model *param2, struct br_material *param3, void *param4);
...
typedef int br_fmt_report_cbfn (char *param1);
...
typedef void br_renderbounds_cbfn (br_actor *param1, br_model *param2, br_material *param3, void *param4, br_uint_8 param5, br_matrix4 *param6);
typedef void br_primitive_cbfn (br_primitive *param1, br_actor *param2, br_model *param3, br_material *param4, br_order_table *param5, br_scalar *param6);
typedef br_material (*br_material_find_cbfn) (char *param1);
typedef br_uint_32 br_material_enum_cbfn (br_material *param1);
typedef br_model (*br_model_find_cbfn) (char *param1);
typedef br_uint_32 br_model_enum_cbfn (br_model *param1);
typedef br_pixelmap (*br_map_find_cbfn) (char *param1);
typedef br_pixelmap (*br_table_find_cbfn) (char *param1);
typedef br_uint_32 br_map_enum_cbfn (br_pixelmap *param1);
typedef br_uint_32 br_table_enum_cbfn (br_pixelmap *param1);
typedef br_uint_32 br_actor_enum_cbfn (br_actor *param1);
typedef int br_pick2d_cbfn (br_actor *param1, br_model *param2, br_material *param3, br_vector3 *param4, br_vector3 *param5, br_scalar param6, br_scalar param7);
typedef int br_pick3d_cbfn (br_actor *param1, br_model *param2, br_material *param3, br_matrix34 *param4, br_bounds *param5);
typedef int br_modelpick2d_cbfn (br_model *param1, br_material *param2, br_vector3 *param3, br_vector3 *param4, br_scalar param5, int param6, int param7, int param8, br_vector3 *param9);
typedef void zs_order_table_traversal_cbfn (int param1, ot_vertex *param2, ot_vertex *param3, ot_vertex *param4, double param5, unsigned char *param6);
typedef BYTE *PBYTE;
typedef char *PSTR;
typedef WORD *PWORD;
...
typedef struct tCar_spec_struct  {
	...
	unsigned int grudge_raised_recently:0;
	unsigned int big_bang:1;
	unsigned int scary_bang:2;
...
typedef void tS3_outlet_callback (tS3_outlet_ptr param1, tS3_sound_tag param2, tS3_termination_reason param3);
typedef void tS3_sample_filter (tS3_effect_tag param1, tS3_sound_tag param2);
...
typedef void (*tPipe_reset_proc) (void param1);
typedef enum  {
	ePowerup_dummy = 0,
...
typedef int (*tGot_proc) (struct tPowerup *param1, tCar_spec *param2);
typedef void (*tLose_proc) (struct tPowerup *param1, tCar_spec *param2);
typedef void (*tPeriodic_proc) (struct tPowerup *param1, tU32 param2);
typedef enum  {
	eVehicle_self = 0,
...
typedef int [123] tKey_array;
typedef tS32 [8] tJoy_array;
typedef void (*tPMFM2CB) (br_material *param1);
...
typedef br_boolean br_outfcty_enum_cbfn (char *param1, br_outfcty_desc *param2, void *param3, __va_list param4);
typedef int dr_pick2d_cbfn (br_actor *param1, br_model *param2, br_material *param3, br_vector3 *param4, br_vector3 *param5, br_scalar param6, br_scalar param7);
typedef void zs_order_table_traversal_cbfn (int param1, ot_vertex *param2, ot_vertex *param3, ot_vertex *param4, struct _complex param5, wchar_t param6);
...
typedef void (*tEdit_func) (void param1);
typedef struct  {
	tU32 code;
	tU32 code2;
...
typedef struct _tag_sos_sample  {
	...
	void (*pfnSampleProcessed) (struct _tag_sos_sample *param1);
	void (*pfnSampleDone) (struct _tag_sos_sample *param1);
	void (*pfnSampleLoop) (struct _tag_sos_sample *param1);
	DWORD wSystem[16];
	DWORD wUser[16];
	struct _tag_sos_sample *pLink;
	struct _tag_sos_sample *pNext;
} _SOS_SAMPLE;
...
typedef struct _tag_sos_driver  {
	...
	void (*pfnPseudoDMAFunction) (void param1);
	PSTR pDMABuffer;
	PSTR pDMABufferEnd;
	...
	W32 wDMARealSeg;
	W32 wID;
	void (*pfnMixFunction) (void param1);
} _SOS_DIGI_DRIVER;
...
typedef struct _tag_sos_system  {
	...
	PSTR (*pMemAllocFunction) (DWORD param1);
	void (*pMemFreeFunction) (PSTR param1, W32 param2);
} _SOS_SYSTEM;
...
typedef void (*SmackTimerSetupType) (void param1);
typedef unsigned long (*SmackTimerReadType) (void param1);
typedef void (*SmackTimerDoneType) (void param1);
...
typedef struct  {
	...
	int (*mouse_click) (int *param1, int *param2, int param3, int param4);
} tMouse_area;
typedef struct  {
	int left[2];
	int top[2];
...
typedef struct  {
	...
	int move_left_min[2];
	int move_left_max[2];
	int (*move_left_proc)[2] (int *param1, int *param2);
	int move_right_new_mode[2];
	int move_right_delta[2];
	int move_right_min[2];
	int move_right_max[2];
	int (*move_right_proc)[2] (int *param1, int *param2);
	int move_up_new_mode[2];
	int move_up_delta[2];
	int move_up_min[2];
	int move_up_max[2];
	int (*move_up_proc)[2] (int *param1, int *param2);
	int move_down_new_mode[2];
	int move_down_delta[2];
	int move_down_min[2];
	int move_down_max[2];
	int (*move_down_proc)[2] (int *param1, int *param2);
	int go_ahead_allowed[2];
	int (*go_ahead_proc)[2] (int *param1, int *param2);
	int escape_allowed[2];
	int (*escape_proc)[2] (int *param1, int *param2);
	int (*exit_proc) (int *param1, int *param2);
	void (*draw_proc) (int param1, int param2);
	tU32 time_out;
	void (*start_proc1) (void param1);
	void (*start_proc2 (void param1);
	int (*done_proc) (int param1, int param2, int param3, int param4, int param5);
	int font_needed;
	int typeable[2];
	void (*get_original_string) (int param1, int param2, char *param3, int *param4);
	int escape_code;
	int dont_save_or_load;
...
typedef br_uint_32 br_enum_cbfn (void *param1, void *param2);
typedef struct br_device  {
	br_uint_32 magic;
	char *identifier;
	struct br_font *default_font;
...
typedef void dev_fill_cbfn (struct br_device *param1, br_pixelmap *param2);
typedef void dev_rectangle_copy_cbfn (struct br_device *param1, br_pixelmap *param2, br_uint_16 param3, br_uint_16 param4, br_pixelmap *param5, br_uint_16 param6);
typedef void dev_rectangle_fill_cbfn (struct br_device *param1, br_pixelmap *param2, br_uint_16 param3, br_uint_16 param4);
typedef void dev_dirty_rectangle_fill_cbfn (struct br_device *param1, br_pixelmap *param2, br_uint_16 param3, br_uint_16 param4);
typedef void dev_dirty_rectangle_copy_cbfn (struct br_device *param1, br_pixelmap *param2, br_pixelmap *param3, br_uint_16 param4, br_uint_16 param5);
typedef void dev_plot_cbfn (struct br_device *param1, br_pixelmap *param2, br_uint_16 param3);
typedef void dev_copy_cbfn (struct br_device *param1, br_pixelmap *param2, br_pixelmap *param3);
typedef void dev_line_cbfn (struct br_device *param1, br_pixelmap *param2, br_int_16 param3, br_int_16 param4);
typedef void dev_copy_bits_cbfn (struct br_device *param1, br_pixelmap *param2, br_int_16 param3, br_int_16 param4, br_uint_8 *param5, br_uint_16 param6);
typedef br_pixelmap (*dev_double_buffer_cbfn) (struct br_device *param1, br_pixelmap *param2, br_pixelmap *param3);
typedef br_pixelmap (*dev_match_cbfn) (struct br_device *param1, br_pixelmap *param2);
typedef br_pixelmap (*dev_clone_cbfn) (struct br_device *param1, br_pixelmap *param2);
typedef void dev_free_cbfn (struct br_device *param1, br_pixelmap *param2);
typedef int dr_pick3d_cbfn (br_actor *param1, br_model *param2, br_material *param3, br_matrix34 *param4, br_bounds *param5);
typedef int dr_modelpick2d_cbfn (br_model *param1, br_material *param2, br_vector3 *param3, br_vector3 *param4, br_scalar param5, int param6, int param7, int param8, br_vector3 *param9);
...
typedef void (*br_find_failed_cbfn) (char *param1);
...
typedef struct br_active_light  {
	...
	void (*light_sub_function) (br_vector3 *param1, br_fvector3 *param2, struct br_active_light *param3, br_scalar *param4);
	int type;
	br_light *light;
} br_active_light;
typedef void br_light_sub_fn (br_vector3 *param1, br_fvector3 *param2, struct br_active_light *param3, br_scalar *param4);
typedef struct br_active_clip_plane  {
	br_vector4 screen_plane;
} br_active_clip_plane;
typedef void br_surface_fn (br_vertex *param1, br_fvector3 *param2, br_scalar *param3);
typedef br_uint_32 br_face_surface_fn (br_vertex *param1, br_face *param2);
typedef void br_model_update_cbfn (br_model *param1);
typedef void br_material_update_cbfn (br_material *param1);
typedef void br_table_update_cbfn (br_pixelmap *param1);
typedef void br_map_update_cbfn (br_pixelmap *param1);
...
typedef br_boolean br_outfcty_enum_cbfn (char *param1, br_outfcty_desc *param2, void *param3, void *param4);
typedef int br_pick2d_cbfn (br_actor *param1, br_model *param2, br_material *param3, br_vector3 *param4, br_vector3 *param5, br_scalar param6);
typedef int br_modelpick2d_cbfn (br_model *param1, br_material *param2, br_vector3 *param3, br_vector3 *param4, br_scalar param5, int param6, int param7, int param8);
typedef void zs_order_table_traversal_cbfn (int param1, ot_vertex *param2, ot_vertex *param3, ot_vertex *param4, int *param5, br_uint_8 param6);
typedef enum  {
	eVehicle_self = 0,
	eVehicle_opponent = 1,
	eVehicle_rozzer = 2,
...
typedef br_boolean br_outfcty_enum_cbfn (char *param1, br_outfcty_desc *param2, void *param3, void param4);
typedef void zs_order_table_traversal_cbfn (int param1, ot_vertex *param2, ot_vertex *param3, ot_vertex *param4, struct __iobuf param5, time_t param6);
typedef enum  {
	eS3_ST_sample = 0,
	eS3_ST_midi = 1,
	eS3_ST_cda = 2
...
typedef struct tS3_channel  {
	...
	struct tS3_outlet *owner_outlet;
	...
	struct tS3_sound_source {
		...
		struct tS3_outlet {
			...
			struct tS3_channel *channel_list;
			struct tS3_outlet *prev;
			struct tS3_outlet *next;
			tS3_outlet_callback *callback;
		} *bound_outlet;
		struct tS3_sound_source *prev;
		struct tS3_sound_source *next;
		int ambient;
...
typedef struct  {
	...
	int (*NotifyFai) (tU32 param1, tNet_message *param2);
	tU32 guarantee_number;
} tGuaranteed_message;
typedef enum  {
...
typedef br_boolean br_outfcty_enum_cbfn (char *param1, br_outfcty_desc *param2, void *param3, onexit_t param4);
typedef void zs_order_table_traversal_cbfn void  (int param1, ot_vertex *param2, ot_vertex *param3, ot_vertex *param4, double param5, long param6);
typedef enum  {
	eJoy_calib_tl_1 = 0,
	eJoy_calib_br_1 = 1,
	eJoy_calib_cn_1 = 2,
...
typedef br_material (**tPMFMCB) (br_model *param1, tU16 param2);
typedef void zs_order_table_traversal_cbfn (int param1, ot_vertex *param2, ot_vertex *param3, ot_vertex *param4, struct INTPACKB param5, union REGS param6);
typedef struct  {
	_IPX_LOCAL_TARGET addr_ipx;
	tU32 last_response;
} tPD_net_game_info;
...
typedef union br_value_tag  {
	...
	struct br_object {
		struct br_object_dispatch {
			void (*__reserved0) (struct br_object *param1);
			void (*__reserved1) (struct br_object *param1);
			void (*__reserved2) (struct br_object *param1);
			void (*__reserved3) (struct br_object *param1);
			void (*_free) (struct br_object *param1);
			char (**_identifier) (struct br_object *param1);
			br_token (*_type) (struct br_object *param1);
			br_boolean (*_isType) (struct br_object *param1, br_token param2);
			struct br_device) (**_device) (struct br_object *param1);
			br_int_32 (*_space) (struct br_object *param1);
			struct br_tv_template (**_templateQuery) (struct br_object *param1);
			br_error (*_query) (struct br_object *param1, br_uint_32 *param2, br_token param3);
			br_error (*_queryBuffer) (struct br_object *param1, br_uint_32 *param2, void *param3, br_size_t param4);
			br_error (*_queryMany) (struct br_object *param1, br_token_value *param2, void *param3, br_size_t param4);
			br_error (*_queryManySize) (struct br_object *param1, br_size_t *param2, br_token_value *param3);
			br_error (*_queryAll) (struct br_object *param1, br_token_value *param2);
			br_error (*_queryAllSize) (struct br_object *param1, br_size_t *param2);
		} *dispatch;
	} **hl;
	br_token *tl;
	void **pl;
...
struct br_object_container_dispatch  {
	...
	br_error (*_queryAll) (struct br_object *param1, br_token_value *param2);
	br_error (*_queryAllSize) (struct br_object *param1, br_size_t *param2);
	void (**_listQuery) (struct br_object_container *param1);
	void (**_tokensMatchBegin) (struct br_object_container *param1, br_token param2, br_token_value *param3);
	br_boolean (*_tokensMatch) (struct br_object_container *param1, struct br_object *param2);
	void (*_tokensMatchEnd) (struct br_object_container *param1);
	br_error (*_addFront) (struct br_object_container *param1, struct br_object *param2);
	br_error (*_removeFront) (struct br_object_container *param1, struct br_object **param2);
	br_error (*_remove) (struct br_object_container *param1, struct br_object *param2);
	br_error (*_find) (struct br_object_container *param1, struct br_object **param2, br_token param3, char *param4);
	br_error (*_findMany) (struct br_object_container *param1, struct br_object **param2, br_int_32 param3, br_int_32 *param4, br_token param5, char *param6);
	br_error (*_count) (struct br_object_container *param1, br_int_32 *param2, br_token param3, char *param4);
};
...
typedef void br_model_custom_cbfn (struct br_actor *param1, struct br_model *param2, struct br_material *param3, void *param4, br_uint_8 param5, int param6, void *param7, br_uint_8 param8);
typedef union br_value_tag  {
	br_uint_32 u32;
	br_boolean b;
	void *p;
	...
	struct br_object {
		struct br_object_dispatch {
			...
			br_int_32 (*_space) (struct br_object *param1);
			struct br_tv_template (**_templateQuery) (struct br_object *param1);
			br_error (*_query) (struct br_object *param1, br_uint_32 *param2, br_token param3, char param4);
			br_error (*_queryBuffer) (struct br_object *param1, br_uint_32 *param2, void *param3, br_size_t param4, br_token param5, char param6);
			br_error (*_queryMany) (struct br_object *param1, br_token_value *param2, void *param3, br_size_t param4, br_int_32 *param5, char param6, br_fixed_lsf param7);
			br_error (*_queryManySize) (struct br_object *param1, br_size_t *param2, br_token_value *param3, char param4, br_fixed_lsf param5);
			br_error (*_queryAll) (struct br_object *param1, br_token_value *param2, br_size_t param3, char param4);
			br_error (*_queryAllSize) (struct br_object *param1, br_size_t *param2, char param3);
		} *dispatch;
	} **hl;
	br_token *tl;
	void **pl;
...
struct br_object_container_dispatch  {
	...
	br_error (*_queryAllSize) (struct br_object *param1, br_size_t *param2, char param3);
	void (**_listQuery) (struct br_object_container *param1);
	void (**_tokensMatchBegin) (struct br_object_container *param1, br_token param2);
	br_boolean (*_tokensMatch) (struct br_object_container *param1, struct br_object *param2);
	void (*_tokensMatchEnd) (struct br_object_container *param1);
	br_error (*_addFront) (struct br_object_container *param1);
	br_error (*_removeFront) (struct br_object_container *param1, struct br_object **param2);
	br_error (*_remove) (struct br_object_container *param1);
	br_error (*_find) (struct br_object_container *param1, struct br_object **param2, br_token param3, char *param4);
	br_error (*_findMany) (struct br_object_container *param1, struct br_object **param2, br_int_32 param3, br_int_32 *param4, br_token param5);
	br_error (*_count) (struct br_object_container *param1, br_int_32 *param2, br_token param3, char *param4);
};
struct br_device_dispatch  {
	void (*__reserved0) (struct br_object *param1);
...
struct br_device_pixelmap_dispatch  {
	...
	br_error (*_queryAll) (struct br_object *param1, br_token_value *param2);
	br_error (*_queryAllSize) (struct br_object *param1, br_size_t *param2);
	br_error (*_validSource) (struct br_device_pixelmap *param1, br_boolean *param2, struct br_object *param3);
	br_error (*_resize) (struct br_device_pixelmap *param1, br_int_32 param2);
	br_error (*_match) (struct br_device_pixelmap *param1, struct br_device_pixelmap **param2, br_token_value *param3);
	br_error (*_allocateSub) (struct br_device_pixelmap *param1, struct br_device_pixelmap **param2, br_rectangle *param3);
	br_error (*_copy) (struct br_device_pixelmap *param1, struct br_device_pixelmap *param2);
	br_error (*_copyTo) (struct br_device_pixelmap *param1, struct br_device_pixelmap *param2);
	br_error (*_copyFrom) (struct br_device_pixelmap *param1, struct br_device_pixelmap *param2);
	br_error (*_fill) (struct br_device_pixelmap *param1);
	br_error (*_doubleBuffer) (struct br_device_pixelmap *param1, struct br_device_pixelmap *param2);
	br_error (*_copyDirty) (struct br_device_pixelmap *param1, struct br_device_pixelmap *param2, br_rectangle *param3);
	br_error (*_copyToDirty) (struct br_device_pixelmap *param1, struct br_device_pixelmap *param2, br_rectangle *param3);
	br_error (*_copyFromDirty) (struct br_device_pixelmap *param1, struct br_device_pixelmap *param2, br_rectangle *param3);
	br_error (*_fillDirty) (struct br_device_pixelmap *param1, br_uint_32 param2, br_rectangle *param3);
	br_error (*_doubleBufferDirty) (struct br_device_pixelmap *param1, struct br_device_pixelmap *param2, br_rectangle *param3);
	br_error (*_rectangle) (struct br_device_pixelmap *param1, br_rectangle *param2);
	br_error (*_rectangle2 (struct br_device_pixelmap *param1, br_rectangle *param2, br_uint_32 param3);
	br_error (*_rectangleCopy) (struct br_device_pixelmap *param1, br_point *param2, struct br_device_pixelmap *param3, br_rectangle *param4);
	br_error (*_rectangleCopyTo) (struct br_device_pixelmap *param1, br_point *param2, struct br_device_pixelmap *param3, br_rectangle *param4);
	br_error (*_rectangleCopyFrom) (struct br_device_pixelmap *param1, br_point *param2, struct br_device_pixelmap *param3, br_rectangle *param4);
	br_error (*_rectangleStretchCopy) (struct br_device_pixelmap *param1, br_rectangle *param2, struct br_device_pixelmap *param3, br_rectangle *param4);
	br_error (*_rectangleStretchCopyTo) (struct br_device_pixelmap *param1, br_rectangle *param2, struct br_device_pixelmap *param3, br_rectangle *param4);
	br_error (*_rectangleStretchCopyFrom) (struct br_device_pixelmap *param1, br_rectangle *param2, struct br_device_pixelmap *param3, br_rectangle *param4);
	br_error (*_rectangleFill) (struct br_device_pixelmap *param1, br_rectangle *param2);
	br_error (*_pixelSet) (struct br_device_pixelmap *param1, br_point *param2);
	br_error (*_line) (struct br_device_pixelmap *param1, br_point *param2, br_point *param3);
	br_error (*_copyBits) (struct br_device_pixelmap *param1, br_point *param2, br_uint_8 *param3, br_uint_16 param4);
	br_error (*_text) (struct br_device_pixelmap *param1, br_point *param2, br_font *param3, char *param4);
	br_error (*_textBounds) (struct br_device_pixelmap *param1, br_rectangle *param2, struct br_font *param3);
	br_error (*_rowSize) (struct br_device_pixelmap *param1, br_size_t *param2);
	br_error (*_rowSet) (struct br_device_pixelmap *param1, void *param2);
	br_error (*_rowQuery) (struct br_device_pixelmap *param1, void *param2);
	br_error (*_pixelQuery) (struct br_device_pixelmap *param1, br_uint_32 *param2, br_point *param3);
	br_error (*_pixelAddressQuery) (struct br_device_pixelmap *param1, void **param2, br_uint_32 *param3, br_point *param4);
	br_error (*_pixelAddressSet) (struct br_device_pixelmap *param1, void *param2);
	br_error (*_originSet) (struct br_device_pixelmap *param1, br_point *param2);
	br_error (*_flush) (struct br_device_pixelmap *param1);
	br_error (*_synchronise) (struct br_device_pixelmap *param1, br_token param2);
	br_error (*_directLock) (struct br_device_pixelmap *param1);
	br_error (*_directUnlock) (struct br_device_pixelmap *param1);
};
struct br_device_pixelmap  {
...
struct br_buffer_stored_dispatch  {
	...
	br_error (*_queryAll) (struct br_object *param1, br_token_value *param2);
	br_error (*_queryAllSize) (struct br_object *param1, br_size_t *param2);
	br_error (*_update) (struct br_buffer_stored *param1, struct br_device_pixelmap *param2, br_token_value *param3);
};
...
struct br_renderer_dispatch  {
	...
	br_error (*_findMany) (struct br_object_container *param1, struct br_object **param2, br_int_32 param3, br_int_32 *param4, br_token param5, char *param6);
	br_error (*_count) (struct br_object_container *param1, br_int_32 *param2, br_token param3, char *param4);
	br_error (*_validDestination) (struct br_renderer *param1, br_boolean *param2, struct br_object *param3);
	br_error (*_stateStoredNew) (struct br_renderer *param1, struct br_renderer_state_stored **param2, br_uint_32 param3);
	br_error (*_stateStoredAvail) (struct br_renderer *param1, br_int_32 *param2, br_uint_32 param3);
	br_error (*_bufferStoredNew) (struct br_renderer *param1, struct br_buffer_stored **param2, br_token param3, struct br_device_pixelmap *param4, br_token_value *param5);
	br_error (*_bufferStoredAvail) (struct br_renderer *param1, br_int_32 *param2, br_token param3, br_token_value *param4);
	br_error (*_partSet) (struct br_renderer *param1, br_token param2, br_int_32 param3, br_token param4);
	br_error (*_partSetMany) (struct br_renderer *param1, br_token param2, br_int_32 param3, br_token_value *param4);
	br_error (*_partQuery) (struct br_renderer *param1, br_token param2, br_int_32 param3, br_uint_32 *param4);
	br_error (*_partQueryBuffer) (struct br_renderer *param1, br_token param2, br_int_32 param3, br_uint_32 *param4, br_uint_32 *param5, br_size_t param6);
	br_error (*_partQueryMany) (struct br_renderer *param1, br_token param2, br_int_32 param3, br_token_value *param4, void *param5);
	br_error (*_partQueryManySize) (struct br_renderer *param1, br_token param2, br_int_32 param3, br_size_t *param4);
	br_error (*_partQueryAll) (struct br_renderer *param1, br_token param2, br_int_32 param3, br_token_value *param4);
	br_error (*_partQueryAllSize) (struct br_renderer *param1, br_token param2, br_int_32 param3);
	br_error (*_partIndexQuery) (struct br_renderer *param1, br_token param2, br_int_32 *param3);
	br_error (*_modelMulF) (struct br_renderer *param1, br_matrix34_f *param2);
	br_error (*_modelMulX) (struct br_renderer *param1, br_matrix34_x *param2);
	br_error (*_modelPopPushMulF) (struct br_renderer *param1, br_matrix34_f *param2);
	br_error (*_modelPopPushMulX) (struct br_renderer *param1, br_matrix34_x *param2);
	br_error (*_modelInvert) (struct br_renderer *param1);
	br_error (*_statePush) (struct br_renderer *param1);
	br_error (*_statePop) (struct br_renderer *param1);
	br_error (*_stateSave) (struct br_renderer *param1, struct br_renderer_state_stored *param2);
	br_error (*_stateRestore) (struct br_renderer *param1, struct br_renderer_state_stored *param2);
	br_error (*_stateMask) (struct br_renderer *param1, br_uint_32 *param2, br_token *param3);
	br_error (*_stateDefault) (struct br_renderer *param1);
	br_error (*_boundsTestF) (struct br_renderer *param1, br_token *param2, br_bounds3_f *param3);
	br_error (*_boundsTestX) (struct br_renderer *param1, br_token *param2, br_bounds3_x *param3);
	br_error (*_coverageTestF) (struct br_renderer *param1, br_float *param2, br_bounds3_f *param3);
	br_error (*_coverageTestX) (struct br_renderer *param1, br_fixed_ls *param2, br_bounds3_x *param3);
	br_error (*_viewDistanceF) (struct br_renderer *param1, br_float *param2);
	br_error (*_viewDistanceX) (struct br_renderer *param1, br_fixed_ls *param2);
	br_error (*_commandModeSet) (struct br_renderer *param1, br_token param2);
	br_error (*_commandModeQuery) (struct br_renderer *param1, br_token *param2);
	br_error (*_commandModeDefault) (struct br_renderer *param1);
	br_error (*_commandModePush) (struct br_renderer *param1);
	br_error (*_commandModePop) (struct br_renderer *param1);
	br_error (*_flush) (struct br_renderer *param1);
	br_error (*_synchronise) (struct br_renderer *param1, br_token param2);
	br_error (*_testRender) (struct br_renderer *param1, br_token param2, union brp_vertex *param3, union brp_vertex *param4, union brp_vertex *param5);
	br_error (*_partQueryCapability) (struct br_renderer *param1, br_token param2, br_int_32 param3, br_token_value *param4);
	br_error (*_stateQueryPerformance) (struct br_renderer *param1, br_fixed_lu *param2);
};
struct br_renderer  {
...
struct br_geometry_stored_dispatch  {
	...
	br_error (*_queryAll) (struct br_object *param1, br_token_value *param2);
	br_error (*_queryAllSize) (struct br_object *param1, br_size_t *param2);
	br_error (*_render) (struct br_geometry_stored *param1, struct br_renderer *param2);
	br_error (*_renderOnScreen) (struct br_geometry_stored *param1, struct br_renderer *param2);
};
...
typedef void br_primitive_cbfn (br_primitive *param1, br_actor *param2, br_model *param3, br_material *param4, br_order_table *param5, br_scalar *param6, br_float param7, br_uint_8 param8);
struct order_info  {
	br_uint_8 a0;
	br_uint_8 a1;
	br_uint_8 a2;
...
typedef struct br_datafile  {
	...
	struct br_file_primitives {
		char *identifier;
		int (*skip) (br_datafile *param1, br_uint_32 param2);
		int (*chunk_write) (br_datafile *param1, br_uint_32 param2, br_uint_32 param3);
		int (*chunk_read) (br_datafile *param1, br_uint_32 *param2);
		void (*count_write) (br_datafile *param1, br_uint_32 param2);
		br_uint_32 (*count_read) (br_datafile *param1);
		int (*count_size) (br_datafile *param1);
		br_uint_32 (*struct_write) (br_datafile *param1, br_file_struct *param2, void *param3, char param4);
		br_uint_32 (*struct_read) (br_datafile *param1, br_file_struct *param2, void *param3, char param4);
		int (*struct_size) (br_datafile *param1, br_file_struct *param2, void *param3, char param4);
		int (*block_write) (br_datafile *param1, void *param2, int param3, int param4, int param5, int param6);
		void (**block_read) (br_datafile *param1, void *param2, int *param3, int param4, int param5);
		int (*block_size) (br_datafile *param1, void *param2, int param3, int param4, int param5, int param6);
		int (*name_write) (br_datafile *param1, char *param2);
		char (**name_read) (br_datafile *param1, char *param2);
		int (*name_size) (br_datafile *param1, char *param2);
	} *prims;
...
typedef struct br_chunks_table_entry  {
	br_uint_32 id;
	br_uint_8 has_count;
	int (*handler) (br_datafile *param1, br_uint_32 param2);
...
typedef union br_value_tag  {
	...
	struct br_object {
		struct br_object_dispatch {
			...
			br_int_32 (*_space) (struct br_object *param1);
			struct br_tv_template (**_templateQuery) (struct br_object *param1);
			br_error (*_query) (struct br_object *param1, br_uint_32 *param2);
			br_error (*_queryBuffer) (struct br_object *param1, br_uint_32 *param2, void *param3);
			br_error (*_queryMany) (struct br_object *param1, br_token_value *param2, void *param3, br_size_t param4);
			br_error (*_queryManySize) (struct br_object *param1, br_size_t *param2, br_token_value *param3);
			br_error (*_queryAll) (struct br_object *param1, br_token_value *param2);
			br_error (*_queryAllSize) (struct br_object *param1, br_size_t *param2);
...
typedef struct br_device_clut  {
	struct br_device_clut_dispatch {
		...
		br_error (*_queryAll) (struct br_object *param1, br_token_value *param2, br_size_t param3, char param4);
		br_error (*_queryAllSize) (struct br_object *param1, br_size_t *param2, char param3);
		br_error (*_entrySet) (struct br_device_clut *param1, br_int_32 param2);
		br_error (*_entryQuery) (struct br_device_clut *param1, br_colour *param2);
		br_error (*_entrySetMany) (struct br_device_clut *param1, br_int_32 param2, br_int_32 param3);
		br_error (*_entryQueryMany) (struct br_device_clut *param1, br_colour *param2, br_int_32 param3);
	} *dispatch;
} br_device_clut;
...
typedef br_uint_32 br_resclass_enum_cbfn (br_resource_class *param1, void *param2);
typedef struct br_device  {
	struct br_device_dispatch {
		void (*__reserved0) (struct br_object *param1);
		void (*__reserved1) (struct br_object *param1);
...
typedef struct br_renderer  {
	struct br_renderer_dispatch {
		...
		br_error (*_stateStoredNew) (struct br_renderer *param1, struct br_renderer_state_stored **param2, br_uint_32 param3);
		br_error (*_stateStoredAvail) (struct br_renderer *param1, br_int_32 *param2, br_uint_32 param3);
		br_error (*_bufferStoredNew) (struct br_renderer *param1, struct br_buffer_stored **param2, br_token param3, struct br_device_pixelmap *param4);
		br_error (*_bufferStoredAvail) (struct br_renderer *param1, br_int_32 *param2, br_token param3);
		br_error (*_partSet) (struct br_renderer *param1, br_token param2, br_int_32 param3);
		br_error (*_partSetMany) (struct br_renderer *param1, br_token param2, br_int_32 param3, br_token_value *param4);
		br_error (*_partQuery) (struct br_renderer *param1, br_token param2, br_int_32 param3);
		br_error (*_partQueryBuffer) (struct br_renderer *param1, br_token param2, br_int_32 param3, br_uint_32 *param4, br_uint_32 *param5);
		br_error (*_partQueryMany) (struct br_renderer *param1, br_token param2, br_int_32 param3, br_token_value *param4, void *param5);
		br_error (*_partQueryManySize) (struct br_renderer *param1, br_token param2, br_int_32 param3, br_size_t *param4);
		br_error (*_partQueryAll) (struct br_renderer *param1, br_token param2, br_int_32 param3);
		br_error (*_partQueryAllSize) (struct br_renderer *param1, br_token param2, br_int_32 param3);
		br_error (*_partIndexQuery) (struct br_renderer *param1, br_token param2);
		br_error (*_modelMulF) (struct br_renderer *param1, br_matrix34_f *param2);
		br_error (*_modelMulX) (struct br_renderer *param1, br_matrix34_x *param2);
		br_error (*_modelPopPushMulF) (struct br_renderer *param1, br_matrix34_f *param2);
		br_error (*_modelPopPushMulX) (struct br_renderer *param1, br_matrix34_x *param2);
		...
		br_error (*_viewDistanceF) (struct br_renderer *param1, br_float *param2);
		br_error (*_viewDistanceX) (struct br_renderer *param1, br_fixed_ls *param2);
		br_error (*_commandModeSet) (struct br_renderer *param1);
		br_error (*_commandModeQuery) (struct br_renderer *param1, br_token *param2);
		br_error (*_commandModeDefault) (struct br_renderer *param1);
		br_error (*_commandModePush) (struct br_renderer *param1);
		br_error (*_commandModePop) (struct br_renderer *param1);
		br_error (*_flush) (struct br_renderer *param1);
		br_error (*_synchronise) (struct br_renderer *param1, br_token param2);
		br_error (*_testRender) (struct br_renderer *param1, br_token param2, union brp_vertex *param3, union brp_vertex *param4);
		br_error (*_partQueryCapability) (struct br_renderer *param1, br_token param2, br_int_32 param3);
		br_error (*_stateQueryPerformance) (struct br_renderer *param1, br_fixed_lu *param2);
	} *dispatch;
} br_renderer;
typedef struct br_device_pixelmap  {
...
typedef struct br_v1db_state  {
	...
	struct br_geometry_lighting {
		struct br_geometry_lighting_dispatch {
			...
			br_error (*_queryAll) (struct br_object *param1, br_token_value *param2, br_size_t param3, char param4);
			br_error (*_queryAllSize) (struct br_object *param1, br_size_t *param2, char param3);
			br_error (*_renderF) (struct br_geometry_lighting *param1, struct br_renderer *param2, br_vector3_f *param3, br_vector3_f *param4, br_colour *param5, br_colour *param6, br_uint_16 *param7, int param8, int param9);
			br_error (*_renderX) (struct br_geometry_lighting *param1, struct br_renderer *param2, br_vector3_x *param3, br_vector3_x *param4, br_colour *param5, br_colour *param6, br_uint_16 *param7, int param8, int param9);
		} *dispatch;
	} *format_lighting;
	br_matrix4 model_to_screen;
	br_matrix34 model_to_view;
...
typedef struct br_renderer_facility  {
	struct br_renderer_facility_dispatch {
		...
		br_error (*_findMany) (struct br_object_container *param1, struct br_object **param2, br_int_32 param3, br_int_32 *param4, br_token param5);
		br_error (*_count) (struct br_object_container *param1, br_int_32 *param2, br_token param3, char *param4);
		br_error (*_validDestination) (struct br_renderer_facility *param1, br_boolean *param2, struct br_object *param3);
		br_error (*_rendererNew) (struct br_renderer_facility *param1, struct br_renderer **param2, br_token_value *param3);
	} *dispatch;
...
typedef struct br_device  {
	struct br_device_dispatch {
		...
		br_error (*_query) (struct br_object *param1, br_uint_32 *param2, br_token param3, char param4);
		br_error (*_queryBuffer) (struct br_object *param1, br_uint_32 *param2, void *param3, br_size_t param4, br_token param5, char param6);
		br_error (*_queryMany) (struct br_object *param1, br_token_value *param2, void *param3, br_size_t param4, br_int_32 *param5, char param6, br_resourcefree_cbfn param7);
		br_error (*_queryManySize) (struct br_object *param1, br_size_t *param2, br_token_value *param3, char param4, br_resourcefree_cbfn param5);
		br_error (*_queryAll) (struct br_object *param1, br_token_value *param2, br_size_t param3, char param4);
		br_error (*_queryAllSize) (struct br_object *param1, br_size_t *param2, char param3);
		void (**_listQuery) (struct br_object_container *param1);
		void (**_tokensMatchBegin) (struct br_object_container *param1, br_token param2);
...
typedef struct br_output_facility  {
	struct br_output_facility_dispatch {
		...
		br_error (*_findMany) (struct br_object_container *param1, struct br_object **param2, br_int_32 param3, br_int_32 *param4, br_token param5);
		br_error (*_count) (struct br_object_container *param1, br_int_32 *param2, br_token param3, char *param4);
		br_error (*_validSource) (struct br_output_facility *param1, br_boolean *param2, struct br_object *param3);
		br_error (*_pixelmapNew) (struct br_output_facility *param1, struct br_device_pixelmap **param2, br_token_value *param3);
		br_error (*_clutNew) (struct br_output_facility *param1, struct br_device_clut **param2, br_token_value *param3);
		br_error (*_queryCapability) (struct br_output_facility *param1, br_token_value *param2, br_token_value *param3);
	} *dispatch;
} br_output_facility;
typedef struct br_device_pixelmap  {
	struct br_device_pixelmap_dispatch {
...
typedef struct br_primitive_library  {
	struct br_primitive_library_dispatch {
		...
		br_error (*_findMany) (struct br_object_container *param1, struct br_object **param2, br_int_32 param3, br_int_32 *param4, br_token param5);
		br_error (*_count) (struct br_object_container *param1, br_int_32 *param2, br_token param3, char *param4);
		br_error (*_stateNew) (struct br_primitive_library *param1, struct br_primitive_state **param2);
		br_error (*_bufferStoredNew) (struct br_primitive_library *param1, struct br_buffer_stored **param2, br_token param3, struct br_device_pixelmap *param4);
		br_error (*_bufferStoredAvail) (struct br_primitive_library *param1, br_int_32 *param2, br_token param3);
		br_error (*_flush) (struct br_primitive_library *param1);
		br_error (*_synchronise) (struct br_primitive_library *param1, br_token param2);
		br_error (*_mask) (struct br_primitive_library *param1, br_uint_32 *param2, br_token *param3);
	} *dispatch;
...
struct br_primitive_state_dispatch  {
	...
	br_error (*_queryAll) (struct br_object *param1, br_token_value *param2, br_size_t param3, char param4);
	br_error (*_queryAllSize) (struct br_object *param1, br_size_t *param2, char param3);
	br_error (*_partSet) (struct br_primitive_state *param1, br_token param2, br_int_32 param3);
	br_error (*_partSetMany) (struct br_primitive_state *param1, br_token param2, br_int_32 param3, br_token_value *param4);
	br_error (*_partQuery) (struct br_primitive_state *param1, br_token param2, br_int_32 param3);
	br_error (*_partQueryBuffer) (struct br_primitive_state *param1, br_token param2, br_int_32 param3, br_uint_32 *param4, br_uint_32 *param5);
	br_error (*_partQueryMany) (struct br_primitive_state *param1, br_token param2, br_int_32 param3, br_token_value *param4, void *param5);
	br_error (*_partQueryManySize) (struct br_primitive_state *param1, br_token param2, br_int_32 param3, br_size_t *param4);
	br_error (*_partQueryAll) (struct br_primitive_state *param1, br_token param2, br_int_32 param3);
	br_error (*_partQueryAllSize) (struct br_primitive_state *param1, br_token param2, br_int_32 param3);
	br_error (*_partIndexQuery) (struct br_primitive_state *param1, br_token param2);
	br_error (*_stateDefault) (struct br_primitive_state *param1);
	br_error (*_stateCopy) (struct br_primitive_state *param1, struct br_primitive_state *param2);
	br_error (*_renderBegin) (struct br_primitive_state *param1, struct brp_block **param2, br_boolean *param3, br_boolean *param4, br_boolean param5);
	br_error (*_renderEnd) (struct br_primitive_state *param1, struct brp_block *param2);
	br_error (*_rangesQueryF) (struct br_primitive_state *param1, br_float *param2, br_float *param3);
	br_error (*_rangesQueryX) (struct br_primitive_state *param1, br_fixed_ls *param2, br_fixed_ls *param3);
	br_error (*_partQueryCapability) (struct br_primitive_state *param1, br_token param2, br_int_32 param3);
	br_error (*_stateQueryPerformance) (struct br_primitive_state *param1, br_fixed_lu *param2);
};
...
typedef struct br_datafile  {
	...
	struct br_file_primitives {
		...
		int (*skip) (br_datafile *param1, br_uint_32 param2);
		int (*chunk_write) (br_datafile *param1, br_uint_32 param2, br_uint_32 param3);
		int (*chunk_read) (br_datafile *param1, br_uint_32 *param2, char param3);
		void (*count_write) (br_datafile *param1, br_uint_32 param2);
		br_uint_32 (*count_read) (br_datafile *param1);
		int (*count_size) (br_datafile *param1);
		br_uint_32 (*struct_write) (br_datafile *param1, br_file_struct *param2, void *param3, char param4);
...
typedef struct br_chunks_table_entry  {
	br_uint_32 id;
	br_uint_8 has_count;
	int (*handler) (br_datafile *param1, br_uint_32 param2, br_uint_32 param3, br_uint_32 param4);
} br_chunks_table_entry;
...
typedef HSOS *PHSOS;
typedef unsigned char *__va_list[1];
typedef struct br_object  {
	struct br_object_dispatch {
		...
		br_error (*_query) (struct br_object *param1, br_uint_32 *param2, br_token param3, char param4);
		br_error (*_queryBuffer) (struct br_object *param1, br_uint_32 *param2, void *param3, br_size_t param4, br_token param5, char param6);
		br_error (*_queryMany) (struct br_object *param1, br_token_value *param2, void *param3, br_size_t param4, br_int_32 *param5, char param6, br_diag_failure_cbfn param7);
		br_error (*_queryManySize) (struct br_object *param1, br_size_t *param2, br_token_value *param3, char param4, br_diag_failure_cbfn param5);
		br_error (*_queryAll) (struct br_object *param1, br_token_value *param2, br_size_t param3, char param4);
		br_error (*_queryAllSize) (struct br_object *param1, br_size_t *param2, char param3);
	} *dispatch;
} br_object;
...
typedef void br_lexer_getchar_cbfn (struct br_lexer_source *param1);
...
typedef void br_lexer_error_cbfn (struct br_lexer *param1, char *param2);
...
struct br_lexer  {
	...
	br_int_32 nkeywords;
	char eol_comment;
	void (*advance) (struct br_lexer *param1);
...
typedef struct br_object  {
	struct br_object_dispatch {
		...
		char (**_identifier) (struct br_object *param1);
		br_token (*_type) (struct br_object *param1);
		br_boolean (*_isType) (struct br_object *param1, br_token param2, char param3);
		struct br_device (**_device) (struct br_object *param1);
		br_int_32 (*_space) (struct br_object *param1);
		struct br_tv_template (**_templateQuery) (struct br_object *param1);
		br_error (*_query) (struct br_object *param1, br_uint_32 *param2, br_token param3, char param4, br_fixed_lsf param5);
		br_error (*_queryBuffer) (struct br_object *param1, br_uint_32 *param2, void *param3, br_size_t param4, br_token param5, char param6, br_fixed_lsf param7);
		br_error (*_queryMany) (struct br_object *param1, br_token_value *param2, void *param3, br_size_t param4, br_int_32 *param5, char param6, br_fixed_lsf param7);
		br_error (*_queryManySize) (struct br_object *param1, br_size_t *param2, br_token_value *param3, char param4, br_fixed_lsf param5);
		br_error (*_queryAll) (struct br_object *param1, br_token_value *param2, br_size_t param3, char param4);
		br_error (*_queryAllSize) (struct br_object *param1, br_size_t *param2, char param3);
...
typedef struct br_object  {
	struct br_object_dispatch {
		...
		char (**_identifier) (struct br_object *param1);
		br_token (*_type) (struct br_object *param1);
		br_boolean (*_isType) (struct br_object *param1);
		struct br_device (**_device) (struct br_object *param1);
		br_int_32 (*_space) (struct br_object *param1);
		struct br_tv_template (**_templateQuery) (struct br_object *param1);
		br_error (*_query) (struct br_object *param1, br_uint_32 *param2);
		br_error (*_queryBuffer) (struct br_object *param1, br_uint_32 *param2, void *param3);
		br_error (*_queryMany) (struct br_object *param1, br_token_value *param2, void *param3, br_size_t param4);
		br_error (*_queryManySize) (struct br_object *param1, br_size_t *param2);
		br_error (*_queryAll) (struct br_object *param1, br_token_value *param2);
		br_error (*_queryAllSize) (struct br_object *param1);
	} *dispatch;
} br_object;
typedef br_error br_tv_custom_query_cbfn (br_uint_32 *param1, void **param2, br_size_t *param3, void *param4, struct br_tv_template_entry *param5, br_uint_8 *param6);
typedef br_error br_tv_custom_set_cbfn (void *param1, br_uint_32 *param2, struct br_tv_template_entry *param3);
typedef br_size_t br_tv_custom_extra_size_cbfn (void *param1, struct br_tv_template_entry *param2);
...
typedef void br_lexer_error_cbfn (struct br_lexer *param1);
struct br_object_container_dispatch  {
	void (*__reserved0) (struct br_object *param1);
	void (*__reserved1) (struct br_object *param1);
	void (*__reserved2) (struct br_object *param1);
